                    ...
                    <div className="max-w-[1205px] w-full mx-auto bg-[#4D0B2F] lg:pt-0 pt-[30px] relative lg:rounded-[24px]">
                        ...
                        <div className="flex justify-between relative items-center lg:flex-row flex-col lg:gap-[0] gap-[50px]">
                            <div className="lg:px-[50px] px-[20px] lg:pb-[36px] lg:pt-[36px] lg:max-w-full max-w-[374px] w-full">
                                ...
                                <p className="font-avenir-400 lg:pb-[98px] pb-[70px] text-[20px] text-[#FFFFFF]">Rooted in Ayurveda and proven through generations of ritual wisdom.</p>
                    ...
                    <div className="max-w-[1205px] w-full mx-auto bg-[#4D0B2F] lg:pt-0 pt-[30px] relative lg:rounded-[24px]">
                        ...
                        <div className="flex justify-between relative items-center lg:flex-row flex-col lg:gap-0 gap-[50px]">
                            <div className="lg:px-[50px] px-[20px] lg:pb-[36px] lg:pt-[36px]">
                                ...
                                <p className="max-w-[538px] lg:pb-[16px] pb-[20px] w-full font-avenir-400 text-[20px] text-[#FFFFFF]">At Raajsi, luxury meets responsibility. Our royal promise is built on integrity, transparency, and timeless care - for you and the planet.</p>
                                <p className="max-w-[587px] w-full font-avenir-800 text-[24px] leading-[28px] text-[#FFFFFF] italic lg:pb-[16px] pb-[20px]">Time-tested formulas derived from ancient sciences and scriptures</p>
                                <p className="font-avenir-400 lg:pb-[78px] pb-[70px] text-[20px] text-[#FFFFFF]">Rooted in Ayurveda and proven through generations of ritual wisdom.</p>
