    ...
    <>
      ...
      <div className="container">
        ...
        <div className="section">
          ...
          <p className="subtitle pb-[14px]">The website www.raajsi.in is owned and operated by Raajsi (referred to as “we”, “our”, “us”).</p>
          <p className="subtitle pb-[14px]">By visiting or purchasing from our website, you engage in our “Service” and agree to be bound by these Terms and Conditions, our Privacy Policy, and Refund Policy.</p>
          <p className="subtitle pb-[14px]">We reserve the right to update or modify these terms at any time without prior notice. Your continued use of the website constitutes acceptance of those changes.</p>
        </div>

        <div className="section">
          <h2 className="section-title">2. Products and Descriptions</h2>
          <p className="subtitle pb-[14px]">
